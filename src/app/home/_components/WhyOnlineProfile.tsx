...
const reasons = [
  {
    ...
    description: "A well-maintained online profile increases your visibility to potential employers.",
    icon: FaUserCircle
  },
  {
    title: "Keep Your Information Current",
    description: "Regularly updating your profile ensures recruiters see your latest skills and experiences.",
    icon: FaSync
  },
  {
    title: "Improve Discoverability",
    description: "Optimized profiles appear more frequently in recruiter searches, increasing your chances of being found.",
    icon: FaSearch
  }
]
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} padding={8}>
          {reasons.map((reason, index) => (
            <VStack 
              ...
              className="animate-on-scroll"
            >
              <Icon as={reason.icon} w={10} h={10} color="purple.500" mb={2} />
