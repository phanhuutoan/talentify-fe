...
const features = [
  {
    ...
    description: "Build a comprehensive professional profile in minutes with our intuitive tools.",
    icon: FaUserPlus
  },
  {
    title: "Skill Highlighting",
    description: "Showcase your unique skills and experiences to stand out to potential employers.",
    icon: FaBriefcase
  },
  {
    title: "Profile Analytics",
    description: "Get insights into who's viewing your profile and how to improve your visibility.",
    icon: FaChartBar
  }
]
